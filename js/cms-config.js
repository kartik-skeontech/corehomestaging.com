...
var CMS_CONFIG = {
  ...
  // Hygraph Studio base URL — used by the Preview SDK for click-to-edit deep-links.
  // Copy from your browser address bar when viewing Studio (just the origin, no path).
  studioUrl: 'https://studio-us-west-2.hygraph.com',
